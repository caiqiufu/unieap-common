...
public class InfConfigVO extends BaseVO{
	...
	private Map<String,String> NSList;
	private Map<String,InfFieldVO> fieldList;
	// same interface have different process in different business scenario
	...
	public Map<String, String> getNSList() {
		return NSList;
	}
	public void setNSList(Map<String, String> nSList) {
		NSList = nSList;
	}
